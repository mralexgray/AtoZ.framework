...
- (void)carousel:(iCarousel *)carousel didSelectItemAtIndex:(NSInteger)index {
	...
	NSLog(@"%@", [AtoZ jsonReuest:$(@"http://api.alternativeto.net/software/%@/?count=5&platform=mac", [[[AtoZ dockSorted]objectAtIndex:index]valueForKey: @"name"])]);
...
- (CGFloat)carouselItemWidth:(iCarousel *)carousel
{
    ...
    return 200;//[[self window]frame].size.width/([[AtoZ dockSorted] count]/self.scalar);// 200.0f;
}
