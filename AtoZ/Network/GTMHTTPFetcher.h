...
//
//  - (void) yFetcher:(GTMHTTPFetcher *)fetcher finishedWithData:(NSData *)retrievedData error:(NSError *)error;
//
...
//
// - (void) yFetcher:(GTMHTTPFetcher *)fetcher finishedWithData:(NSData *)data error:(NSError *)error {
...
//
//  - (void) yFetcher:(GTMHTTPFetcher *)fetcher receivedData:(NSData *)dataReceivedSoFar;
//
...
- (void) pdateRequest:(NSMutableURLRequest *)request isHTTPGet:(BOOL)isHTTPGet;
- (BOOL)shouldCacheETaggedData;
- (NSData *)cachedDataForRequest:(NSURLRequest *)request;
- (id <GTMCookieStorageProtocol>)cookieStorage;
- (void) pdateFetchHistoryWithRequest:(NSURLREQ*)request	 response:(NSURLRES*)response downloadedData:(NSData*)downloadedData;
- (void) emoveCachedDataForRequest:(NSURLREQ*)request;
@end
...
- (void) setcherDidStop:(GTMHTTPFetcher *)fetcher;
...
- (void) uthorizeRequest:(NSMutableURLRequest *)request
				delegate:(id)delegate
	   didFinishSelector:(SEL)sel;

- (void) topAuthorization;
...
//  - (void) yFetcher:(GTMHTTPFetcher *)fetcher
...
//   - (void) setcher:(GTMHTTPFetcher *)fetcher finishedWithData:(NSData *)data error:(NSError *)error;
//
