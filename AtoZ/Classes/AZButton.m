...
- (NSRect)az_drawButtonTitle:(NSAttributedString*)title withFrame:(NSRect)frame inView:(NSView*)controlView {
    ...
    NSDictionary *attributes = [NSDictionary dictionaryWithObjectsAndKeys:AZButtonTextFont, NSFontAttributeName, contrasting, NSForegroundColorAttributeName, textShadow, NSShadowAttributeName, nil];
