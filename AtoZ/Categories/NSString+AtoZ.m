...
- (NSS*)wikiDescription	{	NSError*e;
	...
	NSS*wikiPage = [NSS stringWithContentsOfURL:$URL(searchString) 	encoding:NSUTF8StringEncoding  error:&e]; //NSASCIIStringEncoding
	return e ? @"Error parsing wiki" : [wikiPage parseXMLTag:@"Description"];
}
