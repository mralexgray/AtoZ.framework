...
- (NSString*)stringByConditionallyResolvingAlias	{	NSString* resolvedPath = nil;
		...
		if (CFURLGetFSRef(url, &fsRef))		{
			...
			if ((err == noErr) && wasAliased)
			{
				...
				if (resolvedUrl != NULL)
				{
					...
					resolvedPath = [NSString stringWithString:(__bridge NSString*)resolvedPathCF];
...
- (NSArray*) resolveSymlinksAndAliasesInPaths	{
	...
	NSMutableArray* resolvedPaths = NSMutableArray.new;
