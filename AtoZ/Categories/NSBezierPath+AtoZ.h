...
+ (NSBP*) bezierPathWithRoundedRect:          (NSR)aRect cornerRadius:(CGF)radius   aligned:(AZAlign)corners;
...
+ (void)	fillRoundRectInRect:          (NSR)r radius:(CGF)radius;
+ (void)	strokeRoundRectInRect:        (NSR)r radius:(CGF)radius;
+ (NSBP*) bezierPathWithRoundRectInRect:(NSR)r radius:(CGF)radius;
...
*/
+ (NSBP*) bezierPathWithRoundedRect:      (NSR)r radius:(CGF)rad;
+ (NSBP*) bezierPathWithTopRoundedRect:   (NSR)r radius:(CGF)rad;
+ (NSBP*) bezierPathWithBottomRoundedRect:(NSR)r radius:(CGF)rad;
