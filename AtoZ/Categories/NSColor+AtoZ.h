...
_RO _Colr colorValue;
_RO _Data colorData;

+ _Colr_ colorFromData:_Data_ data;

@end
@interface NSArray (THColorConversion)  _RO NSA * colorValues;
@end
...
//
//_ROHsvColor hsvColor;
//_RORgbColor rgbColor;
//_RO     CGF hue,
//                  saturation,
//                  brightness,
//                  value,
