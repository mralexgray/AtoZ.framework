...
+(NSImage*) randomIcon {
	NSString *ia =  $(@"/picol/%@",[[self class]picolStrings].randomElement);
...
+ (NSArray*) icons {
	...
	NSArray *icons = [[[self class] picolStrings] arrayUsingBlock:^id(id obj) {
//		NSLog(@"loading %@", [obj lastPathComponent]);
		return [self imageWithFileName:obj inBundle:aBundle];
	}].copy;
